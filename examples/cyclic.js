...
if(true ){
computation = (venv.get('valueResidue').value)
setComputedQuestion('sellingPrice',computation)
}
if(true ){
computation = (((venv.get('sellingPrice').value)-(venv.get('privateDebt').value))*2)
...
if(((venv.get('privateDebt').value)>0)){
makeVisible('hasSoldHouse')
}else if(!((venv.get('privateDebt').value)>0)){
makeInvisible('hasSoldHouse')
}
